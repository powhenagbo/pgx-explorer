            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <input class="slider" type="range" id="textSize" name="textSize" value="5" min="2" max="20"
                            step="1" />
                    </td>
                    <td>
                        <label for="bondThickness">Bond Thickness</label>
                        <input class="slider" type="range" id="bondThickness" name="bondThickness" value="0.6"
                    ...
                    <td>
                        ...
                        <input class="slider" type="range" id="shortBondLength" name="shortBondLength" value="85"
                            min="0" max="100" step="1" />
                    </td>
                    <td>
                        <label for="bondSpacing">Bond Spacing</label>
                        <input class="slider" type="range" id="bondSpacing" name="bondSpacing" value="4" min="1"
                            max="99" step="1" />
                    </td>
                    <td>
                        <label for="size">Size</label>
                        <input class="slider" type="range" id="size" name="size" value="500" min="250" max="1000"
                            step="1" />
                    </td>
                    <td>
                        <label for="overlap">Overlap Resolution Steps</label>
                        <input class="slider" type="range" id="overlap" name="overlap" value="1" min="0" max="10"
                            step="1" />
                    </td>
                </tr>
            </tbody>
    ...
    <script>
        ...
        function draw() {
            ...
            SmilesDrawer.parse(input.value, function (tree) {
                ...
                new Noty({
                    text: 'Drawing took ' + td.toFixed(3) + 'ms with a total overlap score of ' +
                        smilesDrawer.getTotalOverlapScore().toFixed(3) + '.',
                    killer: true,
                    timeout: 2000,
                    animation: {
                        open: null,
